...
if not os.path.exists("Jumping ball 5/frames"):
    os.makedirs("Jumping ball 5/frames")
...
while running:
    ...
    if frame_count % 2 == 0:
        pygame.image.save(screen, f"Jumping ball 5/frames/frame_{saved_frame_count:04d}.png")
...
if os.path.exists("Jumping ball 5/output.mp4"):
    os.remove("Jumping ball 5/output.mp4")
subprocess.run([
    "ffmpeg", "-framerate", "60", "-i", "Jumping ball 5/frames/frame_%04d.png",
    "-c:v", "libx264", "-pix_fmt", "yuv420p", "Jumping ball 5/output.mp4"
])

# Delete all frames in the "frames" folder
if os.path.exists("Jumping ball 5/frames"):
    shutil.rmtree("Jumping ball 5/frames")  # Delete entire folder
